    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton(text="🎧 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/Ghazal_Source")],
            ]
        )
        file_name = get_file_name(audio)
        title = file_name
        thumb_name = "https://i.imgur.com/6DGNhHU.jpg"
        ...
        keyboard = InlineKeyboardMarkup(
          [
              [
                  ...
                  InlineKeyboardButton("🎧 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/Ghazal_Source")
              ]
          ]
        )
        requested_by = message.from_user.first_name
