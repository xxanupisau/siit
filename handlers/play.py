...
def r_ply(type_):
    ...
    mar = InlineKeyboardMarkup(
        [
            ...
            [       
                InlineKeyboardButton("اخفاء القائمه𖡶⤈", "cls")
            ]        
        ]
    )
    return mar
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("اخفاء القائمه𖡶⤈", callback_data="cls"),
                ],[
                    InlineKeyboardButton("ٰ𝗔ٰٰ𝗛ِ𝗠ٌٓ𝗘ٰٰ𝗗ِِ 𝗦ٍَ𝗜ِ𝖱ٍ𝗜ٰ𝗔 🦇 ✹", url=f"https://t.me/U_U_U_Q")
                ],
            ]
        )
        ...
        try:
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("انقر لتشغيل الاغنيه الاولي𖡶⤈", callback_data=f'plll 0|{query}|{user_id}'),
                    ],
                    [
                        InlineKeyboardButton("انقر لتشغيل الاغنيه الثانيه𖡶⤈", callback_data=f'plll 2|{query}|{user_id}'),
                    ],
                    [
                        InlineKeyboardButton("انقر لتشغيل الاغنيه الثالثه𖡶⤈", callback_data=f'plll 3|{query}|{user_id}'),
                    ],
